...
%             end
        ...
        case set_ariths  %arithmetic operations
            switch op
                ...
                case {'10', '1c', '14', '01', '02', '03', '04', '16', '0a', '1b', '12'}
                    d=2;
                    a=1;
        ...
        case set_normalhalt
            switch op
                case {'f3', 'fd'} %return or revert
                    ...
                    addr_slots=ceil(addr_len/32);
                    outputs_pt=zeros(addr_slots,3);
                    left_mem=addr_len;
                    for i=0:addr_slots-1
                        if left_mem>=32
                            outputs_pt(i+1,:)=mem_pt(addr_offset+i*32);
                            left_mem=left_mem-32;
                        else
                            temp=mem_pt(addr_offset+i*32);
                            temp(3)=left_mem;
                            outputs_pt(i+1,:)=temp;
                        end
                    end
